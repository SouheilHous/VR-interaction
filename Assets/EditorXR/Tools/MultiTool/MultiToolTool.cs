...
{
    [MainMenuItem("Multitool", "Create", "Open Multi-Tool")]
    [SpatialMenuItem("Multitool", "Tools", "Open Multi-Tool")]
    sealed class MultiToolTool : MonoBehaviour, ITool, IStandardActionMap, IConnectInterfaces, IInstantiateMenuUI,
...
#pragma warning restore 649
        ...
        {
            GameObject.FindGameObjectWithTag("EDITORXR MultiToolMenu").SendMessage("NotifyActive");
        }
    }
}
