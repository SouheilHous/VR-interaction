...
#pragma warning restore 649
        ...
        private bool leftTriggerHeld, rightTriggerHeld;
        ...
        public void ProcessInput(WorkspaceInput input, ConsumeControlDelegate consumeControl)
        {
            ...
            if (m_DragState != null)
            {
                ...
                if ((rayOrigin == leftRayOrigin && (moveResizeLeft.wasJustReleased || !leftTriggerHeld))
                    || (rayOrigin == rightRayOrigin && (moveResizeRight.wasJustReleased || !rightTriggerHeld)))
                {
                    m_DragState = null;
            ...
            if (!dragRayOrigin)
            {
                ...
                if (adjustedBounds.Contains(leftPosition) || adjustedBounds.Contains(leftPointerPosition))
                {
                    ...
                    if (moveResizeLeft.wasJustPressed || leftTriggerHeld)
                    {
                ...
                if (adjustedBounds.Contains(rightPosition) || adjustedBounds.Contains(rightPointerPosition))
                {
                    ...
                    if (moveResizeRight.wasJustPressed || rightTriggerHeld)
                    {
