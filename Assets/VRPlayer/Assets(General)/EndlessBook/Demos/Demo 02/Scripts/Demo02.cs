namespace echo17.EndlessBook.Demo02
{
    ...
    public class Demo02 : MonoBehaviour
    {
        ...
        /// </summary>
        private void TurnOffAllPageViews()
        {
        ...
        private void TogglePageView(int pageNumber, bool on)
        {
        ...
        /// </summary>
        private void TableOfContentsDetected()
        {
        ...
        /// <param name="actionType">The type of action to perform</param>
        /// <param name="actionValue">The value of the action (state or page number)</param>
        private void BookAction(BookActionTypeEnum actionType, int actionValue)
        {
            switch (actionType)
            {
