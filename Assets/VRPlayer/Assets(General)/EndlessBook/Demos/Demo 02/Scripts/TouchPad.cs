namespace echo17.EndlessBook.Demo02
{
    ...
    public class TouchPad : MonoBehaviour
    {
        ...
        /// </summary>
        private const string PageLeftColliderName = "Page Left";
        private const string PageRightColliderName = "Page Right";
        private const string TableOfContentsColliderName = "TableOfContents Button";

        /// <summary>
        /// The minimum amount the mouse needs to move to be considered a drag event
        /// </summary>
        private const float DragThreshold = 0.007f;
        ...
        public void Toggle(PageEnum page, bool on)
        {
        ...
        /// </summary>
        /// <param name="on">Whether to toggle on</param>
        public void ToggleTableOfContents(bool on)
        {
            // activate or deactive the collider
        ...
        private void DetectTouchDown(Vector2 position)
        {
            Vector2 hitPosition;
        ...
        /// </summary>
        /// <param name="position">Position of mouse</param>
        private void DetectDrag(Vector2 position)
        {
        ...
        private void DetectTouchUp(Vector2 position)
        {
        ...
        /// <returns></returns>
        private bool GetHitPoint(Vector3 mousePosition, out Vector2 hitPosition, out Vector2 hitPositionNormalized, out PageEnum page, out bool tableOfContents)
        {
