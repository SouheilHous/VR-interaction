namespace echo17.EndlessBook
{
    ...
    public class EndlessBook : MonoBehaviour
    {
        ...
        /// </summary>
        private struct StandinQualityQueue
        {
        ...
        /// </summary>
        private StateChangedDelegate onCompletedAction;

        /// <summary>
        /// The turn to page data used as the pages are turning
        /// </summary>
        private TurnToPageData turnToPage;
        ...
        /// </summary>
        [SerializeField]
        private Animator bookController;
        ...
        /// </summary>
        [SerializeField]
        private Transform standinsTransform;
        ...
        /// </summary>
        [SerializeField]
        private StandinQualityEnum[] standinQualities;
        ...
        /// </summary>
        [SerializeField]
        private int maxPagesTurningCount = 5;
        ...
        /// </summary>
        [SerializeField]
        private Material pageFillerMaterial;
        ...
        #region Private and Hidden Public
        ...
        /// </summary>
        public void BookAnimationCompleted()
        {
        ...
        /// <returns></returns>
        public StandinQualityEnum GetStandinQuality(StateEnum state)
        {
        ...
        /// <returns></returns>
        public Material GetMaterial(MaterialEnum mat)
        {
        ...
        /// <returns></returns>
        private GameObject LoadStandin(StateEnum state)
        {
        ...
        private void TurnToPageInternal(StateEnum oldState, StateEnum newState, int newPageNumber)
        {
        ...
        public void PageTurnCompleted(Page page)
        {
        ...
        /// <returns></returns>
        private Material GetPageMaterial(int pageNumber)
        {
        ...
        /// <returns></returns>
        private int RightPageNumber(int pageNumber)
        {
        ...
        /// <param name="pageNumber">The page number</param>
        /// <returns></returns>
        private int LeftPageNumber(int pageNumber)
        {
        ...
        /// <param name="pageNumber">The page number</param>
        /// <returns></returns>
        private bool IsInCurrentPageGroup(int pageNumber)
        {
        ...
        /// </summary>
        private void LogInvalidPageNumber()
        {
        ...
        /// </summary>
        /// <param name="go"></param>
        private void RemapGameObjectMaterials(GameObject go)
        {
            if (go == null) return;
        ...
        /// </summary>
        /// <param name="go"></param>
        private void AddMaterialMappings(GameObject go)
        {
        ...
        public void TurnForward(float time,
            StateChangedDelegate onCompleted = null,
        ...
        /// <param name="onPageTurnStart">The handler to call when the page starts to turn. Page turn delegate</param>
        /// <param name="onPageTurnEnd">The handler to call when the page stops turning. Page turn delegate</param>
        public void TurnBackward(float time,
            StateChangedDelegate onCompleted = null,
            PageTurnDelegate onPageTurnStart = null,
            PageTurnDelegate onPageTurnEnd = null
            )
        ...
        /// <param name="onPageTurnStart">The handler to call when the page starts to turn. Page turn delegate</param>
        /// <param name="onPageTurnEnd">The handler to call when the page stops turning. Page turn delegate</param>
        public void TurnToPage(int pageNumber, PageTurnTimeTypeEnum turnType, float time, 
            float openTime = 1f,
            StateChangedDelegate onCompleted = null,
            PageTurnDelegate onPageTurnStart = null,
            PageTurnDelegate onPageTurnEnd = null
            )
        {
            ...
            if (isTurningPages || isChangingState) return;
        ...
        public void SetStandinQuality(StateEnum state, StandinQualityEnum quality)
        {
        ...
        public void SetMaterial(MaterialEnum materialType, Material material)
        {
        ...
        public void SetMaxPagesTurningCount(int newCount)
        {
        ...
        public void SetPageFillerMaterial(Material material)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public PageData AddPageData()
        {
            // create new page data
            var newPage = new PageData()
            {
                material = pageFillerMaterial
            };
        ...
        /// <returns></returns>
        public PageData InsertPageData(int pageNumber)
        {
            // create page data
            var newPage = new PageData()
            {
        ...
        public void SetPageData(int pageNumber, PageData data)
        {
        ...
        public void RemovePageData(int pageNumber)
        {
        ...
        public void MovePageData(int pageNumber, int direction)
        {
