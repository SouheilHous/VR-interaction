...
public class EnviroPostProcessing : MonoBehaviour {
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        tempTexture = RenderTexture.GetTemporary(desc);
#else
        tempTexture = RenderTexture.GetTemporary(source.width, source.height, source.depth, source.format, RenderTextureReadWrite.Default, source.antiAliasing);
#endif
