...
public class EnviroCore : MonoBehaviour
    ...
    public void CalculateDirectLight()
    {
        ...
        if (lightSettings.directionalLightMode == EnviroLightSettings.LightingMode.Single || Components.AdditionalDirectLight == null)
        {
...
#if ENVIRO_HDRP
                lightIntensity = lightSettings.directLightSunIntensity.Evaluate(GameTime.solarTime) * lightSettings.lightIntensityToLumen;
#else
            ...
            {
#if ENVIRO_HDRP
                lightIntensity = lightSettings.directLightMoonIntensity.Evaluate(GameTime.lunarTime) * lightSettings.lightIntensityToLumen;
#else
...
#if ENVIRO_HDRP
            lightIntensitySun = lightSettings.directLightSunIntensity.Evaluate(GameTime.solarTime) * lightSettings.lightIntensityToLumen;
            lightIntensityMoon = lightSettings.directLightMoonIntensity.Evaluate(GameTime.lunarTime) * lightSettings.lightIntensityToLumen * (1 - GameTime.solarTime);
#else
