	...
	public override void OnInspectorGUI ()
	{
		...
		if (showGeneral) {
            ...
            if (EnviroSkyMgr.instance == null || EnviroSkyMgr.instance.currentEnviroSkyVersion == EnviroSkyMgr.EnviroSkyVersion.HD)
            {
                ...
                GUILayout.BeginVertical("Aurora Settings", boxStyle);
                GUILayout.Space(15);
		...
		if (showClouds) {
            ...
            { 
              ...
              //  GUILayout.Space(10);
             //   myTarget.cloudsConfig.coverageModTop = EditorGUILayout.Slider("Coverage Top Modificator", myTarget.cloudsConfig.coverageModTop, 0f, 2f);
        ...
        // Third Party Setup
        GUILayout.BeginVertical("", boxStyle);
        showThirdParty = EditorGUILayout.BeginToggleGroup("Third Party Integrations", showThirdParty);
        if (showThirdParty)
        {
