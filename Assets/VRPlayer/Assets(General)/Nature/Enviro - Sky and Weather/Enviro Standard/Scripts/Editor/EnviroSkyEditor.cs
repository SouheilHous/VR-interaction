...
public class EnviroSkyEditor : Editor {
#if ENVIRO_HD
    private string latestVersion = "2.2.1";
	// GUI Styles 
	...
	SerializedProperty lightIntensityToLumen,angleOffset, lightColorGradient, lightIntensityCurveSun,lightIntensityCurveMoon, shadowStrength, VolumeLightingResolution, globalReflectionsUpdateOnPosition, globalReflectionsUpdateOnGameTime;
