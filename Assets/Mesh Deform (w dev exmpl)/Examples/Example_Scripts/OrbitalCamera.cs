...
//-----------Default unity camera orbit [Source - MouseOrbitImproved_UnityWiki]
...
public class OrbitalCamera : MonoBehaviour {
    ...
    void LateUpdate()
    {
        ...
        if (target)
        {
            ...
            {
                //float distMult = (1 / Vector3.Distance(transform.position, target.position)) * SmartZoomSpeedMultiplier;
                //distance = Mathf.Clamp((distance - Input.GetAxis("Mouse ScrollWheel") * 5) * distMult, distanceMin, distanceMax);
