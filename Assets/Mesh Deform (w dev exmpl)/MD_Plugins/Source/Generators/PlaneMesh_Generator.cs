...
{
    [ExecuteInEditMode]
    [AddComponentMenu(MD_Debug.ORGANISATION + "/MD Plugin/Generators/Plane Generator 2 Sided")]
    public class PlaneMesh_Generator : MonoBehaviour {


        //---PLANE GENERATOR - Two Sided---

        #if UNITY_EDITOR
        [UnityEditor.MenuItem("GameObject/3D Object/MD_Plugin/Plane_Two Sided")]
        #endif
        /// <summary>
